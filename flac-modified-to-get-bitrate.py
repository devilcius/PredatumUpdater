    ...
    * pictures -- list of embedded pictures
    ...
    def load(self, filename):
        ...
        try:
            ...
            # Get the bitrate of the file while fileobj is open.
            start_of_data = fileobj.tell()
            fileobj.seek(0, 2)
            self.metadata_blocks[0].bitrate = \
                int(((fileobj.tell() - start_of_data) * 8) / self.metadata_blocks[0].length)
        finally:
            fileobj.close()
